...
beautiful.font = "DejaVuSansMono Nerd Font Mono 11"
beautiful.menu_width=145
beautiful.menu_height=18

terminal = os.getenv("MYTERM")
...
awful.rules.rules = {
    ...
    {rule = { class = "FzfLauncher" }, properties = { titlebars_enabled = false, floating = true, ontop = true, skip_taskbar = true }, callback = function( c ) 
	    c:geometry({ width = 400, height = 450})
